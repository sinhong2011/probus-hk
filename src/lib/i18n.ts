...
const MESSAGES = {
  ...
  deleteOfflineDone: m.delete_offline_done,
  ...
  emptyStarred: m.empty_starred,
  emptyStarredHint: m.empty_starred_hint,
  ...
  mapZoomIn: m.map_zoom_in,
  mapZoomOut: m.map_zoom_out,
  ...
  starThese: m.star_these,
  addStar: m.add_star,
  starredOn: m.starred_on,
  ...
  starredData: m.starred_data,
  starredDataHint: m.starred_data_hint,
  starredExport: m.starred_export,
  starredImport: m.starred_import,
  starredImportReplace: m.starred_import_replace,
  starredImportReplaceConfirm: m.starred_import_replace_confirm,
  starredExported: m.starred_exported,
  starredImported: m.starred_imported,
  starredImportReplaced: m.starred_import_replaced,
  starredImportFailed: m.starred_import_failed,
  starredImportAdded: m.starred_import_added,
  starredImportSkipped: m.starred_import_skipped,
  starredImportInvalid: m.starred_import_invalid,
  remoteSync: m.remote_sync,
  remoteSyncHint: m.remote_sync_hint,
  remoteSyncOff: m.remote_sync_off,
  ...
  remoteSyncNever: m.remote_sync_never,
  remoteSyncCors: m.remote_sync_cors,
  remoteSyncAuth: m.remote_sync_auth,
  remoteSyncMissing: m.remote_sync_missing,
  remoteSyncInvalid: m.remote_sync_invalid,
  remoteSyncHttp: m.remote_sync_http,
  remoteSyncIncomplete: m.remote_sync_incomplete,
  remoteSyncAuto: m.remote_sync_auto,
  remoteSyncAutoHint: m.remote_sync_auto_hint,
  remoteSyncAutoOn: m.remote_sync_auto_on,
  ...
  s3Key: m.s3_key,
  s3AccessKey: m.s3_access_key,
  s3SecretKey: m.s3_secret_key,
  s3PathStyle: m.s3_path_style,
  s3PathStyleHint: m.s3_path_style_hint,
