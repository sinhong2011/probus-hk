...
const MESSAGES = {
  ...
  tripSun: m.trip_sun,
  tripSunHint: m.trip_sun_hint,
  sunRideLeft: m.sun_ride_left,
  sunRideRight: m.sun_ride_right,
  sunRideOverhead: m.sun_ride_overhead,
  sunRideMixed: m.sun_ride_mixed,
  sunFlipKeepLeft: m.sun_flip_keep_left,
  sunFlipKeepRight: m.sun_flip_keep_right,
  sunWaitExposed: m.sun_wait_exposed,
  sunWaitShaded: m.sun_wait_shaded,
  sunWalkInto: m.sun_walk_into,
  sunWalkAway: m.sun_walk_away,
  sunOffer: m.sun_offer,
  sunOfferTry: m.sun_offer_try,
  sunOfferTitle: m.sun_offer_title,
  sunOfferBody: m.sun_offer_body,
  sunHonesty: m.sun_honesty,
  sunClock: m.sun_clock,
  sunClockHint: m.sun_clock_hint,
  sunClockLive: m.sun_clock_live,
  sunClockNext: m.sun_clock_next,
  sunClockTodayAm: m.sun_clock_today_am,
  sunClockTomorrowAm: m.sun_clock_tomorrow_am,
  sunClockTomorrow: m.sun_clock_tomorrow,
  sunClockDate: m.sun_clock_date,
  sunClockTime: m.sun_clock_time,
  walkRain: m.walk_rain,
  walkRainHint: m.walk_rain_hint,
  rainWalkWet: m.rain_walk_wet,
  rainWalkThunder: m.rain_walk_thunder,
  rainWalkStorm: m.rain_walk_storm,
  rainOffer: m.rain_offer,
  rainOfferTry: m.rain_offer_try,
  rainOfferTitle: m.rain_offer_title,
  rainOfferBody: m.rain_offer_body,
  ...
  creditWeather: m.credit_weather,
  creditRadar: m.credit_radar,
